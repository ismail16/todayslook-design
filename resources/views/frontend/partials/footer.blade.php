                            ...
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo">
                                    <a href="#">
                                        ...
                                        <img class="dark-footer-logo"
                                            src="{{ asset('frontend/images/logo/dark-logo.png') }}" alt="Site Logo"
                                            style="display: none;" />
                                    </a>
                                </div>
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive"
                                        src="{{ asset('frontend/images/product-image/3_1.jpg') }}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive"
                                        src="{{ asset('frontend/images/product-image/3_2.jpg') }}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive"
                                        src="{{ asset('frontend/images/product-image/3_3.jpg') }}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive"
                                        src="{{ asset('frontend/images/product-image/3_4.jpg') }}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive"
                                        src="{{ asset('frontend/images/product-image/3_5.jpg') }}" alt="">
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="ec-nav-panel">
                <div class="ec-nav-panel-icons">
                    <a href="#ec-mobile-menu" class="navbar-toggler-btn header-btn ec-side-toggle"><i
                            class="fi-rr-menu-burger"></i></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#ec-side-cart" class="toggle-cart header-btn ec-side-toggle"><i
                            class="fi-rr-shopping-bag"></i><span
                            class="ec-cart-noti ec-header-count cart-count-lable">3</span></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="index.html" class="header-btn"><i class="fi-rr-home"></i></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="wishlist.html" class="header-btn"><i class="fi-rr-heart"></i><span
                            class="ec-cart-noti">4</span></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="login.html" class="header-btn"><i class="fi-rr-user"></i></a>
                </div>
                        ...
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                ...
                                <div class="ec-img-cont">
                                    <img src="{{ asset('frontend/images/whatsapp/profile_01.jpg') }}"
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{ asset('frontend/images/whatsapp/profile_02.jpg') }}"
                                        class="ec-user-img" alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{ asset('frontend/images/whatsapp/profile_03.jpg') }}"
                                        class="ec-user-img" alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{ asset('frontend/images/whatsapp/profile_04.jpg') }}"
                                        class="ec-user-img" alt="Profile image">
                                    <span class="ec-status-icon ec-offline"></span>
                                </div>
                                <!-- Display Name & Last Seen -->
        ...
        <div class="ec-right-bottom">
            <div class="ec-box">
                <div class="ec-button rotateBackward">
                    <img class="whatsapp" src="{{ asset('frontend/images/common/whatsapp.png') }}"
                        alt="whatsapp icon">
                </div>
            </div>
        </div>
