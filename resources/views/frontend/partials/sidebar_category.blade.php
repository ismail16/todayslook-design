...
<div class="side-cat-overlay"></div>
                ...
                <div class="sidebar-block">
                        ...
                        <ul>
                            <li>
                                <div class="sidebar-block-item"><img
                                        src="{{ asset('frontend/images/icons/dress-8.png') }}" class="svg_img"
                                        alt="drink" />Cothes</div>
                                <ul style="display: block;">
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Shirt
                                                <span title="Available Stock">- 25</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">shorts &
                                    ...
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">dress &
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="sidebar-block-item"><img
                                        src="{{ asset('frontend/images/icons/shoes-8.png') }}" class="svg_img"
                                        alt="drink" />Footwear</div>
                                <ul>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Sports
                                                <span title="Available Stock">- 25</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Formal
                                                <span title="Available Stock">- 52</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Casual
                                                <span title="Available Stock">- 40</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">safety
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="sidebar-block-item"><img
                                        src="{{ asset('frontend/images/icons/jewelry-8.png') }}" class="svg_img"
                                        alt="drink" />jewelry</div>
                                <ul>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Earrings
                                                <span title="Available Stock">- 50</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Couple
                                                Rings <span title="Available Stock">- 35</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Necklace
                                                <span title="Available Stock">- 40</span></a>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="sidebar-block-item"><img
                                        src="{{ asset('frontend/images/icons/perfume-8.png') }}" class="svg_img"
                                        alt="drink" />perfume</div>
                                <ul>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Clothes
                                    ...
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Flower
                                                fragrance <span title="Available Stock">- 10 pack</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Air
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="sidebar-block-item"><img
                                        src="{{ asset('frontend/images/icons/cosmetics-8.png') }}" class="svg_img"
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">body
                                                wash<span title="Available Stock"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">makeup
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="sidebar-block-item"><img
                                        src="{{ asset('frontend/images/icons/glasses-8.png') }}" class="svg_img"
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Lenses
                                                <span title="Available Stock">- 52</span></a>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="sidebar-block-item"><img
                                        src="{{ asset('frontend/images/icons/bag-8.png') }}" class="svg_img"
                                        alt="drink" />bags</div>
                                <ul>
                                    <li>
                                        <div class="sidebar-sub-item"><a
                                    ...
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">Gym
                                                backpack <span title="Available Stock">- 52</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">purse
                                                <span title="Available Stock">- 40</span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-sub-item"><a href="shop-left-sidebar-col-3.html">wallet
